...
class Limit{
    ...
    private static $LIMIT_ARRAY = array(
        'id'=>[
            'noxent', 'admin', 'administrator'
        ],
        'text'=>[
            ...
            'c파','c팔','fuck',
            'ㄱㅐ','ㄲㅏ','ㄲㅑ','ㄲㅣ','ㅅㅂㄹㅁ','ㅅㅐ','ㄱ ㅐㅅ ㅔㄲ ㅣ','ㅆㅂㄹㅁ','ㅆㅍ','ㅆㅣ','ㅆ앙','ㅍㅏ','凸',
            ...
            '걔수작','걔시끼','걔시키','걔썌','걸레','게색기','게색끼','광뇬','구녕','구멍',
            ...
            '씨빠','씨빨','씨뽀랄','씨앙','씨파','씨팍','씨팔','씨펄','씸년','씸뇬','씸새끼','씹같','씹년','씹창년',
            ...
            '호로색','호로쉑','호로스까이','호로스키','후라들','후래자식','후레','후뢰','ㅄ','fuck'
        ]
    );
    
    public static function check($value, $type){
        
        if (!isset(self::$LIMIT_ARRAY[$type])){
            return TRUE;
        }
        foreach (self::$LIMIT_ARRAY[$type] as $key){
