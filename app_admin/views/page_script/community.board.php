<!--CKEDITOR-->
<script src="<?=$GLOBAL_VARS['path_app_etc']?>/plugins/ckeditor/ckeditor.js"></script>
<script src="<?=$GLOBAL_VARS['path_app_js']?>/admin_board.js"></script>
<script>
    CKEDITOR.replace('editor1');
    ADMIN_BOARD.init('<?=$view_name?>');
    // 상세검색 창 여닫기 버튼
